...
- [🙋🏻‍♂개모임 : 개발자를 위한 스터디 모임](#목차)
  ...
  * [🔨 담당 기능](#--------)
  * [⚙️ 개발 과정](#--------)
    + [1. 이벤트 스토밍 : DDD(Domain Driven Design)](#1-----------ddd-domain-driven-design-)
    + [2. DB 테이블 설계](#2-db-------)
    + [3. 화면 설계 : Figma 활용](#3---------figma---)
    + [4. 샘플 데이터 추가](#4----------)
    + [5. SQL 도출](#5-sql---)
    + [6. Repository 설계 : Interface class 기반 구현체](#6-repository------interface-class-------)
    + [7. Service 설계 : Interface class 기반 기능 개발](#7-service------interface-class---------)
    + [8. Controller 설계 : Rest API 개발](#8-controller------rest-api---)
    + [9. TEST : Junit5, PostMan](#9-test---junit5--postman)
    + [10. 화면 구현 : JS, HTML, CSS](#10---------js--html--css)
  * [📓 협업](#-----)
  * [💡 성장하고 배운점](#-----------)
    + [1. 전반적인 웹 개발 능력 함양](#1----------------)
    + [2. 문제 해결](#2------)
